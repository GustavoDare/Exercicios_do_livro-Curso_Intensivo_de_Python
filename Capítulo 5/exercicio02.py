...
'''
Criar testes condicionais utilizando: igualdade e não igualdade para
    strings; a função lower(); igualdade, não igualdade, maior que,
    menor que, maior ou igual a, menor ou igual a para testes 
    numéricos; as palavras 'and' e 'or'; e verificar se um item está e
    não está em uma lista. Obter um True e um False para cada teste.
'''
...
print(f"Meu esporte preferido não é vôlei? "
    f"{esporte_preferido.lower() != 'vôlei'}")
...
print(f"Nasci no ano de 2000 e tenho 21 anos? "
    f"{idade == 21 and ano_nascimento == 2000}")
