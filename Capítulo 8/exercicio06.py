...
'''
Escreva uma função chamada "city_country()" que aceite o nome de uma cidade e seu país. A função deve devolver uma string formatada 
...
cidade_pais = {'brasília':'brasil', 'berlim':'alemanha', 'buenos aires':'argentina'}
