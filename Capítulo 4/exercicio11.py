...
'''
Copiar o exercício 1 do capítulo 4, fazer uma cópia da lista, adicionar uma pizza na lista original e outra, diferente, 
    na cópia, e exibir as duas listas provando que são listas diferentes
'''
