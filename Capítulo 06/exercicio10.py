...
'''
Modifique o seu programa do Exercício 6.2 (página 147) para que cada pessoa possa ter mais de um número favorito. Em seguida, 
    apresente o nome de cada pessoa, juntamente com seus números favoritos.
'''

numeros_favoritos = {'maria': [5], 'gustavo': [7, 27], 'josé': [21, 45, 97], 'joana': [5, 11], 'lucas': [10]}
