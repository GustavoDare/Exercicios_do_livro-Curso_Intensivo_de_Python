...
# Criar uma lista com 5 lugares, exbir a lista, exibir a lista em ordem alfabética com sorted(),
#     exibir a lista na forma original, exebir a lista em ordem alfabética inversa com sorted(),
#     exibir a lista na forma original, utilizar reverse() na lista e exibí-la, repetir este último,
#     utilizar sort() na lista e exibí-la, utilizar sort() na lista deixando em ordem alfabética inversa
#     e exibí-la.
