...
Crie uma lista de pessoas que devam participar da enquete sobre 
    linguagem favorita. Inclua alguns nomes que já estejam no dicionário
    e outras que não estão.
Percorra a lista de pessoas que devem participar da enquete. Se elas já
    tiverem respondido à enquete, mostre uma mensagem agradecendo-lhes 
    por responder. Se ainda não participaram da enquete, apresente uma 
...
for pessoa in pessoas:
    if pessoa in linguagem_favorita.keys():
        ...
        print(f"Olá {pessoa.title()}, gostaria de convidá-lo(a) a respoder "
        "a enquete sobre qual é sua linguagem de programação favorita.")
