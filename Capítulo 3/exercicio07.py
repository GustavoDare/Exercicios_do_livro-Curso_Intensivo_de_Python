...
'''
Modificar o exercício 6 do capítulo 3: Manter apenas 2 convidados, mandando mensagens de desculpas aos que foram retirados 
    e reafirmando o convite aos dois que sobraram. No final, deletar esses dois convidados e mostrar que a lista atual está vazia.
'''
