...
# Modificar o exercício 4 do capítulo 3 adicionando mais 3 convidados utilizando insert() e append()
# Colocar um convidado no início, outro no meio e outro no final da lista e exibir os convites novamente
