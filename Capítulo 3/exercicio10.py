...
paises = ["brasil", "argentina", "estados unidos", "chile", "portugal", 
    "itália"]
...
print(f"Alterando temporáriamente a lista em ordem alfabética: "
    f"{sorted(paises)}")
...
print(f"Lista com o pais '{pais_excluido}' excluido utilizando pop(): "
    f"{paises}\n")
