...
'''
Modificar o exercício 4 do capítulo 3 retirando e acrescentando outro nome na listas de convidados, e exibir o motivo do 
    convidado ser retirado e enviar novamente os convites aos convidados.
'''
